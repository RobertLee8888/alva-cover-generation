// Single-line tag row with overflow-hide-only-fitting behavior.
...
function TemplateGlyph({ template, color }: { template: Template; color: string }) {
  ...
  return (
    <svg width={10} height={10} viewBox={viewBox} preserveAspectRatio="xMidYMid meet"
